...
fn synthesize_person_records(config: &ResolutionJobConfig) -> Vec<EntityRecord> {
	let profiles = [
		(
			...
			["john.smith@acme.com", "jon.smyth@acme.com", "john.smith+support@acme.com"],
		...
		(
			...
			["ana.perez@nova.io", "anna.peres@nova.io", "ana.perez+ops@nova.io"],
		...
		(
			...
			["mei.chen@harbor.ai", "may.chen@harbor.ai", "mei.chen+crm@harbor.ai"],
...
fn synthesize_organization_records(config: &ResolutionJobConfig) -> Vec<EntityRecord> {
	let profiles = [
		(
			...
			["ops@acme-logistics.com", "support@acme-logistics.com", "hello@acme-logistics.com"],
		...
		(
			...
			["info@novaenergy.io", "ops@novaenergy.io", "hello@novaenergy.io"],
