...
pub fn catalog_entry() -> GeneratorCatalogEntry {
	GeneratorCatalogEntry {
		...
		capabilities: vec!["pixel-perfect layout".to_string(), "page headers".to_string()],
	}
}
...
pub fn generate(
	...
	build_bundle(report, snapshot, execution_id, generated_at, "pdf", "application/pdf", "typst")
}
