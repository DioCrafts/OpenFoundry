...
use crate::{
	domain::{data_fetcher::ReportDataSnapshot, generators::{build_bundle, GeneratedBundle}},
...
pub fn catalog_entry() -> GeneratorCatalogEntry {
	GeneratorCatalogEntry {
		...
		capabilities: vec!["interactive preview".to_string(), "embedded charts".to_string()],
	}
}
...
pub fn generate(
	...
	build_bundle(report, snapshot, execution_id, generated_at, "html", "text/html", "html renderer")
}
