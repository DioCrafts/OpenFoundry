...
use crate::models::{sink::WindowAggregate, topology::TopologyDefinition, window::WindowDefinition};
...
pub fn simulate_window_aggregates(
	...
	let slide_seconds = window.map(|value| value.slide_seconds).unwrap_or(duration_seconds as i32) as i64;
